...
ActiveRecord::Schema.define(version: 20131203223529) do

  create_table "doenca_pessoas", force: true do |t|
    t.date     "data"
    t.text     "observacao"
  ...
  add_index "pessoas", ["doencas_id"], name: "index_pessoas_on_doencas_id", using: :btree
